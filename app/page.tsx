...
export default function Home() {
  ...
  if (!session || !snapshot) return <><main className="landing">
    ...
    <section className="hero">
      <div className="hero-copy"><h1>MURLAN</h1><div className="suits"><span>♠<small>{t.suits.S}</small></span><span>♣<small>{t.suits.C}</small></span><span>♦<small>{t.suits.D}</small></span><span>♥<small>{t.suits.H}</small></span></div></div>
