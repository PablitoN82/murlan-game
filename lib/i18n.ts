...
const it = {
  ...
  onlineMode:"Online", passPlayMode:"Passa e gioca", localPlayers:"Nomi dei 4 giocatori", botNames:"Nomi dei bot (facoltativi)", startLocal:"Inizia sullo stesso dispositivo", passDevice:"Passa il dispositivo a", revealHand:"Mostra le mie carte", translationFailed:"Traduzione non disponibile. Riprova.",
...
const en: typeof it = { ...it,
  install:"Install app",
  onlineMode:"Online", passPlayMode:"Pass & play", localPlayers:"Names of the 4 players", botNames:"Bot names (optional)", startLocal:"Start on this device", passDevice:"Pass the device to", revealHand:"Show my cards", translationFailed:"Translation unavailable. Try again.",
...
const es: typeof it = { ...it,
  ...
  onlineMode:"En línea", passPlayMode:"Pasa y juega", localPlayers:"Nombres de los 4 jugadores", botNames:"Nombres de los bots (opcionales)", startLocal:"Empezar en este dispositivo", passDevice:"Pasa el dispositivo a", revealHand:"Mostrar mis cartas", translationFailed:"Traducción no disponible. Inténtalo de nuevo.",
...
const sq: typeof it = { ...it,
  ...
  onlineMode:"Online", passPlayMode:"Kalo dhe luaj", localPlayers:"Emrat e 4 lojtarëve", botNames:"Emrat e boteve (opsionale)", startLocal:"Fillo në këtë pajisje", passDevice:"Kaloja pajisjen", revealHand:"Shfaq letrat e mia", translationFailed:"Përkthimi nuk është i disponueshëm. Provo përsëri.",
